                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <a href="/booking" class="btn btn-primary py-3 px-5 animated slideInDown">Booking Now!<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex py-5 px-4">
                        ...
                        <div class="ps-4">
                            ...
                            <p>refers to high standards in vehicle maintenance and repair services. It covers various aspects that ensure customers have a satisfying experience and their vehicles are well treated.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="d-flex bg-light py-5 px-4">
                        ...
                        <div class="ps-4">
                            ...
                            <p>workers who have special skills and knowledge in a particular field, supported by formal training, years of experience, and regular competency updates. In the context of vehicle maintenance and repair services, Expert Workers refer to mechanics and technicians who have the ability to handle a wide range of vehicle problems with a high level of precision and expertise.</p>
                            <a class="text-secondary border-bottom" href="service">Read More</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4"><span class="text-primary">Mequeen Service</span> Is The Best Place For Your Auto Care</h1>
                    <p class="mb-4">MeQueen is a car service established with a vision to provide reliable, efficient, and convenient car maintenance and repair solutions for vehicle owners. Based on years of experience in the automotive industry, MeQueen is here to fill the gap in quality and reliable service.</p>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h2 class="text-white mb-2" data-toggle="counter-up">1251</h2>
                        ...
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-4">has completed many projects carried out by skilled workers in their fields</p>
                                    <p><i class="fa fa-check text-success me-3"></i>Quality Servicing</p>
                                    <p><i class="fa fa-check text-success me-3"></i>Expert Workers</p>
                                    <p><i class="fa fa-check text-success me-3"></i>Modern Equipment</p>
                                    <a href="service" class="btn btn-primary py-3 px-5 mt-3">Read More<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
